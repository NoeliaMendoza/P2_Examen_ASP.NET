    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Details(short? id)
        {
            ...
            var category = await _context.Categories
                .FirstOrDefaultAsync(m => m.CategoryId == id && m.Discontinued == 0);
            if (category == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(short? id)
        {
            ...
            var category = await _context.Categories
                .FirstOrDefaultAsync(c => c.CategoryId == id && c.Discontinued == 0);
            if (category == null)
            {
                return NotFound();
            }
        ...
        {
            return _context.Categories.Any(e => e.CategoryId == id && e.Discontinued == 0);
        }
    }
}
